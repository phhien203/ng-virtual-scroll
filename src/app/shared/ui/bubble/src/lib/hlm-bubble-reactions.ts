...
const bubbleReactionsVariants = cva(
  'bg-muted ring-card absolute z-10 flex w-fit shrink-0 items-center justify-center gap-0.5 rounded-full px-1.5 py-0.5 text-[0.625rem] ring-2 has-[button]:p-0',
  {
    variants: {
      side: {
