...
export class HlmMenubarTrigger {
  ...
  constructor() {
    ...
    classes(
      () =>
        'hover:bg-muted aria-expanded:bg-muted flex items-center rounded-[calc(var(--radius-md)-2px)] px-2 py-[calc(--spacing(0.85))] text-xs/relaxed font-medium outline-hidden select-none data-disabled:pointer-events-none data-disabled:opacity-50',
    );
  }
}
