  ...
  template: `
    ...
    >
      ...
      @for (i of _slider.thumbIndexes(); track i) {
        <span
          class="border-primary ring-ring/30 absolute block size-4 shrink-0 rounded-md border bg-white shadow-sm transition-colors select-none after:absolute after:-inset-2 hover:ring-4 focus-visible:ring-4 focus-visible:outline-hidden"
          brnSliderThumb
        ></span>
      }
    </div>
