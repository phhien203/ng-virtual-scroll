...
export class HlmSelectScrollDown {
  constructor() {
    classes(
      () =>
        "bg-popover sticky bottom-0 z-10 flex w-full cursor-default items-center justify-center py-1 data-hidden:hidden [&_ng-icon:not([class*='text-'])]:text-[length:--spacing(3.5)]",
    );
  }
}
